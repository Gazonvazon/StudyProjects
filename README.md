# StudyProjects
Описание результатов проектов, которые были выпрлнены во время обучения. Большинство из них содержится в данном п=репозитории.
...
В основной части ("Анализ поведения пользователей в мобильном приложении") были выделены основные сценарии использования приложения, оценены работающие и неработающие "фичи", даны рекомендации что можно улучшить. По результатам анализа подготовлен дашборд и презентация.
